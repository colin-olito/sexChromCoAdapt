...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\title{Supplementary Material (Appendix B) for: Sexually antagonistic coevolution between the sex chromosomes of {\itshape Drosophila melanogaster}. \textit{PNAS}}

\author{Katrine K.~Lund-Hansen$^{a}$, Colin Olito$^{a}$, Edward H.~Morrow$^{b}$, \& Jessica K.~Abbott$^{a}$}
\date{\today}

\begin{document}
\maketitle

\noindent{} $^{a}$ Department of Biology, Section for Evolutionary Ecology, Lund University, Lund 223 62, Sweden.

\noindent{} $^{b}$ School of Life Sciences, University of Sussex, Brighton BN1 9QG, United Kingdom.
...
\rhead{\textit{Coevolution between the sex chromosomes}\\ }
\renewcommand{\headrulewidth}{0pt}
\renewcommand{\footrulewidth}{0pt}
\addtolength{\headheight}{12pt}


\section{Appendix B: Development of the recursions}
